	...
	public static void main(String[] args) {
		...
		while (command!=4) {	//명령 번호가 4일때까지 아래를 반복
			...
			case 1 :
				...
				printIceCreamMenu();	//아이스크림 메뉴 출력하는 메소드로 연결
			...
			case 2 :
				...
				printCoffeeMenu();		//커피 메뉴 출력하는 메소드로 연결
			...
			case 3 : 
				...
				printDrinkMenu();		//음료 메뉴 출력하는 메소드로 연결
